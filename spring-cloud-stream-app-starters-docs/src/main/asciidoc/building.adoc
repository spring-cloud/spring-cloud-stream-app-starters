...
before bulding.  See below for more information on how run Redis.
...
You can build just the documentation by running the following command:

[listing, subs=attributes]
----
$ ./mvnw package -DskipTests=true -P full -pl {project-artifactId} -am
----
