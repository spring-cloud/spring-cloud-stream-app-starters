//tag::ref-doc[]
= TCP Client as a processor which connects to a TCP server, sends/waits for data
...
$$tcp.retry-interval$$:: $$Retry interval to check the connection and reconnect$$ *($$Long$$, default: `$$60000$$`)*
