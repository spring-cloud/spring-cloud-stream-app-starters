...
package org.springframework.cloud.stream.app.test.fieldvaluecounter;
...
/**
 * Test configuration for the generated field value counter sink app.
 *
 * @author Gary Russell
 *
 */
@Configuration
public class FieldValueCounterSinkTestConfiguration {
