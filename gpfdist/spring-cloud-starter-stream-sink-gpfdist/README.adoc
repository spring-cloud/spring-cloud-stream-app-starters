...
$$gpfdist.batch-count$$:: $$<documentation missing>$$ *($$Integer$$, default: `100`)*
$$gpfdist.batch-period$$:: $$<documentation missing>$$ *($$Integer$$, default: `10`)*
$$gpfdist.batch-timeout$$:: $$<documentation missing>$$ *($$Integer$$, default: `4`)*
$$gpfdist.column-delimiter$$:: $$<documentation missing>$$ *($$Character$$, default: `<none>`)*
$$gpfdist.control-file$$:: $$<documentation missing>$$ *($$Resource$$, default: `<none>`)*
$$gpfdist.db-host$$:: $$<documentation missing>$$ *($$String$$, default: `localhost`)*
$$gpfdist.db-name$$:: $$<documentation missing>$$ *($$String$$, default: `gpadmin`)*
$$gpfdist.db-password$$:: $$<documentation missing>$$ *($$String$$, default: `gpadmin`)*
$$gpfdist.db-port$$:: $$<documentation missing>$$ *($$Integer$$, default: `5432`)*
$$gpfdist.db-user$$:: $$<documentation missing>$$ *($$String$$, default: `gpadmin`)*
$$gpfdist.delimiter$$:: $$<documentation missing>$$ *($$String$$, default: `
`)*
$$gpfdist.error-table$$:: $$<documentation missing>$$ *($$String$$, default: `<none>`)*
$$gpfdist.flush-count$$:: $$<documentation missing>$$ *($$Integer$$, default: `100`)*
$$gpfdist.flush-time$$:: $$<documentation missing>$$ *($$Integer$$, default: `2`)*
$$gpfdist.gpfdist-port$$:: $$<documentation missing>$$ *($$Integer$$, default: `0`)*
$$gpfdist.match-columns$$:: $$<documentation missing>$$ *($$String$$, default: `<none>`)*
$$gpfdist.mode$$:: $$<documentation missing>$$ *($$String$$, default: `<none>`)*
$$gpfdist.null-string$$:: $$<documentation missing>$$ *($$String$$, default: `<none>`)*
$$gpfdist.rate-interval$$:: $$<documentation missing>$$ *($$Integer$$, default: `0`)*
$$gpfdist.segment-reject-limit$$:: $$<documentation missing>$$ *($$String$$, default: `<none>`)*
$$gpfdist.segment-reject-type$$:: $$<documentation missing>$$ *($$SegmentRejectType$$, default: `<none>` possible values: `ROWS`,`PERCENT`)*
$$gpfdist.sql-after$$:: $$<documentation missing>$$ *($$String$$, default: `<none>`)*
$$gpfdist.sql-before$$:: $$<documentation missing>$$ *($$String$$, default: `<none>`)*
$$gpfdist.table$$:: $$<documentation missing>$$ *($$String$$, default: `<none>`)*
$$gpfdist.update-columns$$:: $$<documentation missing>$$ *($$String$$, default: `<none>`)*
$$spring.net.hostdiscovery.loopback$$:: $$<documentation missing>$$ *($$Boolean$$, default: `false`)*
$$spring.net.hostdiscovery.match-interface$$:: $$<documentation missing>$$ *($$String$$, default: `<none>`)*
$$spring.net.hostdiscovery.match-ipv4$$:: $$<documentation missing>$$ *($$String$$, default: `<none>`)*
$$spring.net.hostdiscovery.point-to-point$$:: $$<documentation missing>$$ *($$Boolean$$, default: `false`)*
$$spring.net.hostdiscovery.prefer-interface$$:: $$<documentation missing>$$ *($$String>$$, default: `<none>`)*
